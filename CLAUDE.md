...
**Sprint corrente:** Settimana 5 — Sessione 4-bis (refresh token auto-rotation) o Sessione 5 (admin clients endpoints + onboarding wizard)
...
**Prossima milestone:** Refresh token auto-rotation (Sessione 4-bis) + admin clients endpoints e onboarding wizard (Sessione 5).
